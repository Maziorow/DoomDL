    ...
    def _on_step(self) -> bool:
        for info in self.locals["infos"]:
            if "episode_stats" in info:
                ...
                ]) #zapis po każdej epoce aby mieć wszystkie statystyki
...
def main(args):
    ...
    log_dir = "logi/logs3_doomExpert_10_bcTrain_ppoTrain_ppoTime_3500000_envs1_lr1e3_evalFq_70000/"
    ...
    if args.bc_train:
        for expert_gameplay in expert_set:
            ...
            # nie da się zupełnie wyłączyć rng
    ...
    if args.ppo_train:
        ...
        eval_callback = EvalCallback( #bardzo spowalnia uczenie tworząc nowe środowisko w którym musi porównać otrzymany model do najlepszego
            eval_env,
        ...
        checkpoint_callback = CheckpointCallback( #zmieniłem częstotliwość tworzenia checkpoitu tak aby przy 3 500 000 i 70000 krokach dawało 10 zapisów
            #save_freq=3 * args.eval_frequency, # Every third eval
            save_freq = 5 * args.eval_frequency,
            save_path=ckpt_dir,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ppo_timesteps", type=int, default=3000000) # przy 7000 krokach będzie 500 epok dla 3 500 000
    parser.add_argument("--envs", type=int, default=8)
    parser.add_argument("--model", type=str, default="NONE")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--learning_rate", type=float, default=0.0001)
    parser.add_argument("--eval_frequency", type=int, default=7000) #aby nie spowalniać tak uczenia będzie sprawdzało poprawność modelu co 10 epok 70 000 timesteps
